        ...
        <div class="relative -mx-4 flex items-center justify-between">
          ...
          <div class="flex w-full items-center justify-between px-4">
            <div>
              ...
              <nav :class="!navbarOpen &amp;&amp; 'hidden' " id="navbarCollapse" class="absolute right-4 top-full w-full max-w-[250px] rounded-lg bg-white py-5 px-6 shadow lg:static lg:block lg:w-full lg:max-w-full lg:shadow-none hidden">
