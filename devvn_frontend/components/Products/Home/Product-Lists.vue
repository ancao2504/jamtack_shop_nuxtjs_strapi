<template>
    ...
    <div class="2xl:container 2xl:mx-auto">
        ...
        <div class="py-6 lg:px-20 md:px-6 px-4">
            <p class="font-normal text-sm leading-3 text-gray-600 dark:text-gray-300">Home / Shop by Category / Women</p>
            ...
            <div class="grid lg:grid-cols-4 sm:grid-cols-2 grid-cols-1 lg:gap-y-12 lg:gap-x-8 sm:gap-y-10 sm:gap-x-6 gap-y-6 lg:mt-12 mt-10">
                ...
                <div class="relative">
                    ...
                    <nuxt-link :to="`/products/${product.attributes.Slug}`" class="group">
                    ...
                    <p class="font-normal dark:text-white text-xl leading-5 text-gray-800 md:mt-6 mt-4">{{ product.attributes.Title }}</p>
                    <p class="font-semibold dark:text-gray-300 text-xl leading-5 text-gray-800 mt-4">{{ product.attributes.Price }}</p>
